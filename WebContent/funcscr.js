...
function gatherWDLTableData(idx){
	...
	var t1={name:tds[1].textContent, winIn:Number(tds[4].textContent), winOut:Number(tds[8].textContent), 
			drawIn:Number(tds[12].textContent), drawOut:Number(tds[16].textContent), 
			loseIn:Number(tds[20].textContent), loseOut:Number(tds[24].textContent)};
	
	
	var t2={name:tds[2].textContent, winIn:Number(tds[5].textContent), winOut:Number(tds[9].textContent), 
			drawIn:Number(tds[13].textContent), drawOut:Number(tds[17].textContent), 
			loseIn:Number(tds[21].textContent), loseOut:Number(tds[25].textContent)};
	return ([t1,t2]);
}
