...
public class ServiceMsg {
	...
	public static final String END_OF_DATA="END OF STORED DATA";
	public static final String DATE_ERR_PARSE="DATE ERROR PARSE";
	public static final String DATE_NO_REC="DATE NO RECORDS";
	public static final String DATE_ID_NO_REC="ID ON DATE NO RECORDS";
	...
	public static final String RETR_ERROR_CSV="CSV RETREIAL PROBLEMS";
